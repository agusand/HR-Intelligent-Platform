...
@Module({
  ...
  controllers: [AppController, QuestionController, ProfileController, AnswerController],
  providers: [AppService, MigrationsService, QuestionService, ProfileService, AnswerService],
})
